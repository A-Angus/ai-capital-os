...
If the user just says "inbox triage" with no content, ask: "Paste your emails or describe what's in your inbox, and I'll sort them by priority and draft responses for the urgent ones."
...
- **If all items are low priority:** Say so directly: "Nothing urgent. [X] items can be batched. [X] can be deleted. Your inbox is clean — no action needed right now."
