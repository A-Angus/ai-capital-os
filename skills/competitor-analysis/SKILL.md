...
*Competitive intelligence compiled by AI OS. Markets shift — revisit this analysis quarterly.*
```
...
- **If WebSearch is unavailable or returns errors:** Inform the user: "Web search is not available right now. I can provide a competitive analysis based on my training data, but pricing and recent developments may not be current. Want me to proceed?"
...
- **If the user does not specify what product or market to analyze:** Ask: "What product, service, or market do you want me to analyze the competitive landscape for? For example: 'creative finance platforms', 'AI OS products', or 'online course platforms'."
