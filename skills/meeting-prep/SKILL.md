...
Meeting Prep builds a complete intelligence dossier before any meeting, call, or conversation. The user provides who the meeting is with and what it is about. AI researches the person and/or company, checks internal CRM notes, constructs a tailored agenda, develops talking points with supporting evidence, anticipates objections, and generates a post-meeting follow-up template. The output is a single document the user can glance at 5 minutes before the meeting and walk in prepared like they spent hours getting ready.
...
*Prepared by AI OS. Update brain/people/{name}.md after the meeting with outcomes and next steps.*
```
