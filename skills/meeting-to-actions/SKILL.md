...
- **If action items have no deadlines:** Set them as "Deadline: TBD" and suggest: "None of these action items had specific deadlines mentioned. Want me to set default deadlines (e.g., 1 week from today) or leave them as TBD?"
