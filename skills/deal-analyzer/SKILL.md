...
```
~/Desktop/ai-os-blueprint/output/deal-analyses/{address-slug}-{date}.md
```
...
---
*Generated by AI OS Blueprint - Deal Analyzer*
```
...
- **If the output directory does not exist:** Create `~/Desktop/ai-os-blueprint/output/deal-analyses/` automatically before saving.
