...
```
~/Desktop/ai-os-blueprint/output/deal-marketing/{address-slug}/
├── one-pager.md
...
---
*Generated by AI OS Blueprint - Deal Marketing Package*
```
...
All saved to `~/Desktop/ai-os-blueprint/output/deal-marketing/2847-westfield-blvd-indianapolis/`
...
- **If the output directory does not exist:** Create `~/Desktop/ai-os-blueprint/output/deal-marketing/{address-slug}/` automatically before saving files.
