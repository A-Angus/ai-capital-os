...
Save to:
```
~/Desktop/ai-os-blueprint/output/rental-analyses/{address-or-area-slug}-{date}.md
```
...
**Date:** {date}
**Analyzed by:** AI Rental Analyzer
...
---
*Generated by AI OS Blueprint - Rental Analysis*
```
...
- **If the output directory does not exist:** Create `~/Desktop/ai-os-blueprint/output/rental-analyses/` automatically before saving.
