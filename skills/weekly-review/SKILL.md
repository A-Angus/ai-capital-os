...
- **If no daily log files exist for the review period:** Report: "No daily logs found for {date range}. Either work was not logged this week, or the days were off. I'll base the review on project file changes and goals only." Proceed with available data.
