...
Email Drafter writes professional, well-crafted emails for any business context. The user describes who they are emailing, why, and the desired outcome, and AI produces a ready-to-send email matching the appropriate tone, length, and structure. Supports cold outreach, follow-ups, proposals, negotiations, introductions, thank-yous, deal communications, and more. Can batch-draft multiple emails in one session. Checks the brain for recipient context to personalize automatically.
...
- **If the recipient has no entry in `brain/people/`:** Proceed with whatever context the user provides. Do not block on missing CRM data. Note: "I don't have {name} in your contacts, so I'm working with the context you gave me. Want me to create a contact entry?"
- **If the user asks to "send" the email:** Clarify that this skill drafts emails only — it does not send them. "I've drafted the email for you. Copy it into your email client and send when ready. I don't have the ability to send emails directly."
