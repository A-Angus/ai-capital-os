...
Brain Dump is the fastest way to get information into the shared brain. The user speaks naturally — a thought, a fact, a decision, a contact, a goal update, anything — and AI analyzes the content, determines the correct brain/ subdirectory, and files it in the right place using the correct template format. No manual filing, no thinking about where it goes.
