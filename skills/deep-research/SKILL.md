...
Deep Research performs a thorough investigation of any topic using web search to find current data, statistics, trends, competitors, market sizing, expert opinions, and key insights. It compiles everything into a well-organized, citation-rich markdown research document saved to the brain/research/ directory. This is not surface-level Googling — it is structured, multi-angle research that produces an actionable intelligence document.
...
*Research compiled by AI OS. Verify critical data points before making major decisions.*
```
