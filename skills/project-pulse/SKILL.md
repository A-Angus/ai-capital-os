...
Performs a quick pulse check across all active projects in `brain/projects/`. Reads every project file and the project dashboard, then generates a real-time status report that highlights what is on track, what is behind, what is blocked, and what needs attention today. Designed for a 60-second glance at your entire project portfolio.
