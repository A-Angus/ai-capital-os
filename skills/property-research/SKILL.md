...
Save to:
```
~/Desktop/ai-os-blueprint/output/property-research/{address-slug}-{date}.md
```
...
**Date:** {date}
**Compiled by:** AI Property Researcher
...
---
*Generated by AI OS Blueprint - Property Research*
```
...
**AI runs all research steps and compiles:**
...
- **If the output directory does not exist:** Create `~/Desktop/ai-os-blueprint/output/property-research/` automatically before saving.
