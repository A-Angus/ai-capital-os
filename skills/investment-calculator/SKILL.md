...
Before any specific analysis, the AI uses these standard formulas:
...
Save to:
```
~/Desktop/ai-os-blueprint/output/investment-calcs/{description-slug}-{date}.md
```
...
**AI builds side-by-side comparison showing both scenarios with all metrics.**
...
- **If the output directory does not exist:** Create `~/Desktop/ai-os-blueprint/output/investment-calcs/` automatically before saving.
